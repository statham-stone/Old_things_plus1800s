...
<body id="skin-blur-violate" onload="checkCookies()">
  ...
  Input column details:
	...
	out.print(" <p>Column name 1 :<input readonly=\"readonly\" class=\"input-sm validate[required] form-control\" type=\"text\" id=\"column_name"+ 1+ "\" " +"name=\""+" column_name"+1+"\"required=\"required\" value=\"Name\" /></input> </p>");
	out.print(" <p hidden >Column length:<input readonly=\"readonly\" class=\"input-sm validate[required] form-control\"   type=\"text\" id=\"column_length"+1+ "\" "+"name=\""+"column_length"+1+"\" required=\"required\" value=\"50\"  /></input> </p>");
	
	
	for( int i=2;i<=Integer.parseInt(column_number_string);i++)
	{
		out.print(" <p>Column name "+i+" :<input  class=\"input-sm validate[required] form-control\" type=\"text\" id=\"column_name"+ i+ "\" " +"name=\""+" column_name"+i+"\"required=\"required\" /></input> </p>");
		out.print(" <p hidden >Column length:<input  value=\"50\" class=\"input-sm validate[required] form-control\"   type=\"text\" id=\"column_length"+i+ "\" "+"name=\""+"column_length"+i+"\" required=\"required\" /></input> </p>");
	}
